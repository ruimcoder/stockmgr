...
TRANSLATIONS = {
    "en": {
        ...
        "product.edit_title": "Edit product details",
        "product.edit_note": "Updates are applied to all batches of this product.",
    ...
    "pt": {
        ...
        "product.edit_title": "Editar detalhes do produto",
        "product.edit_note": "As alteracoes sao aplicadas a todos os lotes deste produto.",
